# Generated by Django 2.1 on 2019-03-14 05:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appi.Categoria')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='producto',
            name='subcategoria',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appi.SubCategoria'),
        ),
